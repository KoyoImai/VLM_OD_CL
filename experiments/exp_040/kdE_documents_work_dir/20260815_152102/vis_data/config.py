...
model = dict(
    ...
    teacher_ckpt='experiments/exp_040/kdE_microscopic_work_dir/epoch_20.pth',
...
past_pool = dict(
    datasets=[
        dict(
            ann_file=
            '/workspace/kouyou/mmdetection/experiments/exp_023/buffer/underwater_500.odvg.json',
            data_prefix=dict(img='train/'),
        ...
        dict(
            ann_file=
            '/workspace/kouyou/mmdetection/experiments/exp_023/buffer/electromagnetic_500.odvg.json',
            data_prefix=dict(img='train/'),
            data_root=
            '/workspace/kouyou/datasets/rf100_domain/electromagnetic/',
            filter_cfg=dict(filter_empty_gt=False),
        ...
        dict(
            ann_file=
            '/workspace/kouyou/mmdetection/experiments/exp_023/buffer/videogames_500.odvg.json',
            data_prefix=dict(img='train/'),
        ...
        dict(
            ann_file=
            '/workspace/kouyou/mmdetection/experiments/exp_023/buffer/aerial_500.odvg.json',
            data_prefix=dict(img='train/'),
        ...
        dict(
            ann_file=
            '/workspace/kouyou/mmdetection/experiments/exp_023/buffer/microscopic_500.odvg.json',
            data_prefix=dict(img='train/'),
            ...
            dict(
                datasets=[
                    ...
                    dict(
                        ...
                        data_prefix=dict(img='train/'),
                        data_root=
                        '/workspace/kouyou/datasets/rf100_domain/videogames/',
                        filter_cfg=dict(filter_empty_gt=False),
                        label_map_file='videogames_label_map.json',
                        pipeline=[
                            dict(backend_args=None, type='LoadImageFromFile'),
                    ...
                    dict(
                        ...
                        data_prefix=dict(img='train/'),
                        data_root=
                        '/workspace/kouyou/datasets/rf100_domain/aerial/',
                        filter_cfg=dict(filter_empty_gt=False),
                        label_map_file='aerial_label_map.json',
                        pipeline=[
                            dict(backend_args=None, type='LoadImageFromFile'),
                    ...
                    dict(
                        ...
                        data_prefix=dict(img='train/'),
                        data_root=
                        '/workspace/kouyou/datasets/rf100_domain/microscopic/',
                        filter_cfg=dict(filter_empty_gt=False),
                        label_map_file='microscopic_label_map.json',
                        pipeline=[
                            dict(backend_args=None, type='LoadImageFromFile'),
...
work_dir = 'experiments/exp_040/kdE_documents_work_dir'
