...
model = dict(
    ...
    teacher_ckpt=
    '/workspace/kouyou/mmdetection/experiments/exp_028/kdB_condA_l2_electromagnetic_work_dir/epoch_20.pth',
...
work_dir = 'experiments/exp_028/kdB_condA_l2_videogames_work_dir'
