#!/bin/bash
# =============================================================================
# exp_028_b sbatch.sh — クラスタ実行の「器」。
#   note05 の分割に対応: exp_028_b = 蒸留D（融合後）+ 蒸留E（全部）
...
#     sbatch experiments/exp_028/sbatch_b.sh          # all（2条件を直列・約86h）
#
...
# =============================================================================
#SBATCH --job-name=exp028b_kdDE_condA_l2
...
singularity exec --nv \
  ...
  "$SIF" bash /workspace/kouyou/mmdetection/experiments/exp_028/train_val_b.sh "$RUN_STAGE"
