# =============================================================================
# exp_050: DGS stage1 / t=5 microscopic（RF100 逐次）
# 【自動生成】experiments/exp_050/gen_configs.py。直接編集しない。
# データ・スケジュールは ../../exp_040/configs/replayfree_microscopic.py を継承し、
...
model = dict(
    ...
    num_tasks=6,
    task_id=4,
    seen_tasks='underwater,electromagnetic,videogames,aerial,microscopic',
    moe_cfg=moe_cfg,
