# =============================================================================
# exp_050: DGS stage1 / t=3 videogames（RF100 逐次）
# 【自動生成】experiments/exp_050/gen_configs.py。直接編集しない。
# データ・スケジュールは ../../exp_024/configs/fullft_replayfree_videogames.py を継承し、
...
model = dict(
    ...
    num_tasks=6,
    task_id=2,
    seen_tasks='underwater,electromagnetic,videogames',
    moe_cfg=moe_cfg,
