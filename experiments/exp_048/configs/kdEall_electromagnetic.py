# =============================================================================
# exp_048: 条件2 kdEall（リプレイ[4,1,1]×6・全6枚に蒸留E） / electromagnetic（逐次 t=2）
#
# 【自動生成】experiments/exp_048/gen_configs.py。直接編集しない。
#
# データ・スケジュールは ../../exp_023/configs/fullft_replay_electromagnetic.py
...
# =============================================================================
_base_ = '../../exp_023/configs/fullft_replay_electromagnetic.py'
