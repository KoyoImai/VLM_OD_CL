...
echo "SLURM_JOB_ID=${SLURM_JOB_ID} CACHE=$CACHE  exp_062 ours b5"
singularity exec --nv \
  ...
  "$SIF" bash -c "METHOD=ours COND=b5 GPUS=4 bash /workspace/kouyou/mmdetection/experiments/exp_062/run_sequential.sh"
