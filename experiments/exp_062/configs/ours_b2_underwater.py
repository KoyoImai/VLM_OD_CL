# exp_062 バッチ内訳感度 ours/b2（内訳 [4,2,2] batch8・t>=2）/ underwater（t=1）
# 【自動生成】experiments/exp_062/gen_configs.py。直接編集しない。
# ベースとの差分: バッファ ann_file 1 箇所 ＋ 内訳（t>=2: source_ratio[4,2,2]/batch8）。
...
{'batch_size': 6,
 ...
 'sampler': {'type': 'CurrentEpochMultiSourceSampler', 'batch_size': 6, 'source_ratio': [2, 1]},
