...
echo "SLURM_JOB_ID=${SLURM_JOB_ID} CACHE=$CACHE  exp_062 er b3"
singularity exec --nv \
  ...
  "$SIF" bash -c "METHOD=er COND=b3 GPUS=4 bash /workspace/kouyou/mmdetection/experiments/exp_062/run_sequential.sh"
