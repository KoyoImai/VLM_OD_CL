# exp_061 バッファサイズ感度 er/b4（参照 4000・過去 2000/ドメイン）/ electromagnetic（t=2）
# 【自動生成】experiments/exp_061/gen_configs.py。直接編集しない。
# ベースとの差分はバッファ ann_file（2 箇所）と ckpt 保存方針のみ（内訳は base のまま）。
_base_ = '/workspace/kouyou/mmdetection/experiments/exp_027/configs/fullft_replay_electromagnetic.py'
