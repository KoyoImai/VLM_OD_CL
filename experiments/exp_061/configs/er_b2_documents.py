# exp_061 バッファサイズ感度 er/b2（参照 2000・過去 1000/ドメイン）/ documents（t=6）
# 【自動生成】experiments/exp_061/gen_configs.py。直接編集しない。
# ベースとの差分はバッファ ann_file（6 箇所）と ckpt 保存方針のみ（内訳は base のまま）。
_base_ = '/workspace/kouyou/mmdetection/experiments/exp_040/configs/replay_documents.py'
                          ...
                          {'type': 'ConcatDataset',
                           'datasets': [{'type': 'ODVGDataset',
                                        ...
                                        {'type': 'ODVGDataset',
                                         ...
                                         'ann_file': '/workspace/kouyou/mmdetection/experiments/exp_058/buffer/microscopic_1000.odvg.json',
