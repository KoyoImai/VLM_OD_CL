...
model = dict(
    ...
    teacher_ckpt=
    '/workspace/kouyou/mmdetection/experiments/exp_033/kdD_condA_l2w30_electromagnetic_work_dir/epoch_20.pth',
...
work_dir = 'experiments/exp_033/kdD_condA_l2w30_videogames_work_dir'
