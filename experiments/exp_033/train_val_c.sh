#!/bin/bash
# =============================================================================
# exp_033_c train_val.sh — 条件A + L2 蒸留 + リプレイ / **λ = 3.0 固定**
...
run () { bash experiments/exp_028/run_sequential_kd.sh exp_033 condA l2w30 "$1"; }
...
echo "==== exp_033_c train_val ($STAGE) 完了 ===="
