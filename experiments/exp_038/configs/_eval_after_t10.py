...
#   時点: t=10（直前に学習したタスク: NorthAmericaMushrooms）
#   対象タスク（逐次順）: pistols / PascalVOC / CottontailRabbits / Raccoon / VehiclesOpenImages / Packages / thermalDogsAndPeople / pothole / EgoHands / NorthAmericaMushrooms
# =============================================================================
