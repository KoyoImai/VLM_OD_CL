...
echo "SLURM_JOB_ID = ${SLURM_JOB_ID}   CACHE = $CACHE   exp_059 w50"
...
singularity exec --nv \
  ...
  "$SIF" bash -c "COND=w50 GPUS=4 bash /workspace/kouyou/mmdetection/experiments/exp_059/run_sequential.sh"
