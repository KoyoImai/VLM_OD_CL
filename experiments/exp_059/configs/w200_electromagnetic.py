# =============================================================================
# exp_059: 蒸留係数感度 w200（λ=20.0）/ electromagnetic（t=2）
...
# =============================================================================
_base_ = '/workspace/kouyou/mmdetection/experiments/exp_035/configs/kdE_condA_l2w100_electromagnetic.py'

model = dict(kd=dict(loss_weight=20.0))
