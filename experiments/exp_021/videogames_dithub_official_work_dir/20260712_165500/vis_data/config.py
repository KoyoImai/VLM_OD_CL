...
model = dict(
    ...
    backbone=dict(
        ...
        with_cp=True),
    bbox_head=dict(
        contrastive_cfg=dict(bias=True, log_scale='auto', max_text_len=512),
...
test_evaluator = dict(
    ann_file=
    '/workspace/kouyou/datasets/rf100_domain/videogames/valid/_annotations.coco.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = 'experiments/exp_021/videogames_dithub_official_work_dir'
