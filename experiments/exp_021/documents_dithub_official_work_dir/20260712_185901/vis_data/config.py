...
coco_od_dataset = dict(
    ...
    type='ODVGDataset')
custom_hooks = [
    dict(type='DitHubPhaseHook', warmup_iters=1500),
]
custom_imports = dict(
...
test_evaluator = dict(
    ann_file=
    '/workspace/kouyou/datasets/rf100_domain/documents/valid/_annotations.coco.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
train_cfg = dict(max_iters=3000, type='IterBasedTrainLoop', val_interval=3000)
...
work_dir = 'experiments/exp_021/documents_dithub_official_work_dir'
