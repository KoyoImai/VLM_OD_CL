...
launcher = 'pytorch'
load_from = '/workspace/kouyou/mmdetection/experiments/exp_024/fullft_replayfree_electromagnetic_work_dir/epoch_20.pth'
log_level = 'INFO'
...
work_dir = 'experiments/exp_024/eval_after_electromagnetic/on_electromagnetic'
