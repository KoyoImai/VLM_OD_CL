# =============================================================================
# exp_052: 蒸留E × 学習可能モジュール = BERT + text_feat_map / underwater（逐次 t=1）
#
...
# =============================================================================
_base_ = '../../exp_035/configs/kdE_condA_l2w100_underwater.py'

optim_wrapper = dict(
    paramwise_cfg=dict(
        custom_keys=dict(
            backbone=dict(lr_mult=0.0),  # 凍結
            language_model=dict(lr_mult=0.1),  # 学習
            neck=dict(lr_mult=0.0),  # 凍結
            text_feat_map=dict(lr_mult=1.0),  # 学習
