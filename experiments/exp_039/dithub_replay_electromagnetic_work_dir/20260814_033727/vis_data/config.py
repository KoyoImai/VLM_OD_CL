...
current_electromagnetic = dict(
    ...
    type='ODVGDataset')
custom_hooks = [
    dict(trained_classes=[], type='DitHubSeqPhaseHook', warmup_epochs=10),
]
custom_imports = dict(
...
launcher = 'pytorch'
load_from = 'experiments/exp_039/dithub_replay_merged/merged_after_t1_underwater.pth'
log_level = 'INFO'
...
work_dir = 'experiments/exp_039/dithub_replay_electromagnetic_work_dir'
