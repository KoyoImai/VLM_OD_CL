...
launcher = 'pytorch'
load_from = '/workspace/kouyou/mmdetection/experiments/exp_023/zira_replayfree_electromagnetic_work_dir/iter_2000.pth'
log_level = 'INFO'
...
test_evaluator = dict(
    ann_file=
    '/workspace/kouyou/datasets/rf100_domain/electromagnetic/valid/_annotations.coco.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = 'experiments/exp_023/zira_replayfree_eval_after_electromagnetic/on_electromagnetic'
