# =============================================================================
# exp_023 DitHub 評価用 / ZCOCO（COCO2017-val ゼロショット）
#   逐次ライブラリ ckpt を全クラス(152) DitHub モデルで読み、COCO2017-val を評価。
#   COCO クラスのうちライブラリにモジュールを持つもの（person/car 等）だけに A が当たり、
#   他は凍結モデル（θ0）を通る（DitHub の構造的ゼロショット保護）。
#   COCO データ・pipeline は eval_base_coco.py を継承。既存コード無変更。
# =============================================================================
