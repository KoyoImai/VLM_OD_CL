# =============================================================================
# exp_023 比較手法: 条件A + リプレイ / underwater
...
#   fullft_replay_underwater.py を継承し、optim_wrapper の paramwise（lr_mult）だけ差し替える。
#   学習モジュールの lr_mult は full FT と同一（Swin/BERT=0.1、他=1.0）。
#   評価は素の GroundingDINO 用 eval_underwater.py をそのまま使える（custom detector 不要）。
#   既存コード無変更。
# =============================================================================
