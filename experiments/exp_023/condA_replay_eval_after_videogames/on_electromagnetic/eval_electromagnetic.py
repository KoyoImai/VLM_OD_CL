...
launcher = 'pytorch'
load_from = '/workspace/kouyou/mmdetection/experiments/exp_023/condA_replay_videogames_work_dir/epoch_20.pth'
log_level = 'INFO'
...
work_dir = 'experiments/exp_023/condA_replay_eval_after_videogames/on_electromagnetic'
