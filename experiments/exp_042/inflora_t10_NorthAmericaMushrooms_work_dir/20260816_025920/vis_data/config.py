...
model = dict(
    ...
    inflora=dict(
        design_path='experiments/exp_042/inflora_designs/design_t10.pth'),
    language_model=dict(
    ...
    lora=dict(
        alpha=16,
        decompose_mha=[
            '^encoder\\.text_layers\\.\\d+\\.self_attn\\.attn$',
        ],
        exclude_components=[],
        include=[
            'backbone',
...
work_dir = 'experiments/exp_042/inflora_t10_NorthAmericaMushrooms_work_dir'
