#!/bin/bash
# =============================================================================
# exp_053 decoder — クラスタ実行の「器」（design.md §3）。
...
#
#   使い方（マスターノードで）: sbatch experiments/exp_053/sbatch_decoder.sh
...
# =============================================================================
#SBATCH --job-name=exp053_decoder
...
echo "SLURM_JOB_ID = ${SLURM_JOB_ID}   CACHE = $CACHE   exp_053 decoder"
...
singularity exec --nv \
  ...
  "$SIF" bash -c "COND=decoder GPUS=4 bash /workspace/kouyou/mmdetection/experiments/exp_053/run_sequential.sh"
