# =============================================================================
# exp_049: DGS 評価（t=8 時点・学習済み 8 タスク per-dataset）
...
val_dataloader = dict(
    batch_size=1,
    dataset=dict(_delete_=True, type='ConcatDataset', datasets=[dataset_AerialMaritimeDrone, dataset_Aquarium, dataset_CottontailRabbits, dataset_EgoHands, dataset_NorthAmericaMushroom, dataset_Packages, dataset_PascalVOC, dataset_pistols]))
test_dataloader = val_dataloader

val_evaluator = dict(
    _delete_=True,
    type='MultiDatasetsEvaluator',
    metrics=[val_evaluator_AerialMaritimeDrone, val_evaluator_Aquarium, val_evaluator_CottontailRabbits, val_evaluator_EgoHands, val_evaluator_NorthAmericaMushroom, val_evaluator_Packages, val_evaluator_PascalVOC, val_evaluator_pistols],
    dataset_prefixes=['AerialMaritimeDrone', 'Aquarium', 'CottontailRabbits', 'EgoHands', 'NorthAmericaMushroom', 'Packages', 'PascalVOC', 'pistols'])
