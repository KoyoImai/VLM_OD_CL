# =============================================================================
# exp_049: DGS 評価（t=3 時点・学習済み 3 タスク per-dataset）
...
model = dict(
    ...
    num_tasks=13,
    task_id=2,
    seen_tasks='AerialMaritimeDrone,Aquarium,CottontailRabbits',
    moe_cfg=moe_cfg,
...
val_dataloader = dict(
    batch_size=1,
    dataset=dict(_delete_=True, type='ConcatDataset', datasets=[dataset_AerialMaritimeDrone, dataset_Aquarium, dataset_CottontailRabbits]))
test_dataloader = val_dataloader

val_evaluator = dict(
    _delete_=True,
    type='MultiDatasetsEvaluator',
    metrics=[val_evaluator_AerialMaritimeDrone, val_evaluator_Aquarium, val_evaluator_CottontailRabbits],
    dataset_prefixes=['AerialMaritimeDrone', 'Aquarium', 'CottontailRabbits'])
