...
dataset_NorthAmericaMushroom = dict(
    ann_file=
    'North American Mushrooms.v2-416x416augmented.coco/train/annotations_without_background.json',
    data_prefix=dict(
        img='North American Mushrooms.v2-416x416augmented.coco/train/'),
...
launcher = 'pytorch'
load_from = 'experiments/exp_049/work_dirs/VehiclesOpenImages/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    domain_predictor_cfg=dict(
        ...
        task_id_mapping_path=
        'experiments/exp_049/work_dirs/task_id_mapping.yaml',
        type='svd'),
    encoder=dict(
    ...
    moe_cfg=dict(
        ...
        experts_num=1,
        group_cfg=dict(
            lambda_A=0.2, lambda_B=0.2, merge_method='ema', type='rep'),
        r=16,
        replace_dec_layer_ids=[],
        replace_enc_layer_ids=[
            0,
            1,
            2,
            3,
    ...
    seen_tasks=
    'AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushroom,Packages,PascalVOC,pistols,pothole,Raccoon,ShellfishOpenImages,thermalDogsAndPeople,VehiclesOpenImages',
    task_id=12,
    ...
    vis_cfg=dict(save_path='', type='none'),
    with_box_refine=True)
moe_cfg = dict(
    alpha=32.0,
    dropout=0.0,
    experts_num=1,
    group_cfg=dict(lambda_A=0.2, lambda_B=0.2, merge_method='ema', type='rep'),
    r=16,
    replace_dec_layer_ids=[],
    replace_enc_layer_ids=[
        0,
    ...
    dataset=dict(
        datasets=[
            ...
            dict(
                ...
                data_prefix=dict(
                    img=
                    'North American Mushrooms.v2-416x416augmented.coco/train/'
                ),
                data_root='data/odinw/NorthAmericaMushrooms/',
                metainfo=dict(classes=(
                    'CoW',
...
test_evaluator = dict(
    ...
    metrics=[
        dict(
            ann_file=
            'data/odinw/AerialMaritimeDrone/tiled/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/Aquarium/Aquarium Combined.v2-raw-1024.coco/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/CottontailRabbits/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/EgoHands/generic/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/NorthAmericaMushrooms/North American Mushrooms.v2-416x416augmented.coco/train/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/Packages/augmented-v1/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
        ...
        dict(
            ann_file=
            'data/odinw/pistols/export/test_annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/pothole/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/Raccoon/Raccoon.v38-416x416-resize.coco/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/ShellfishOpenImages/416x416/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/thermalDogsAndPeople/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
        dict(
            ann_file=
            'data/odinw/VehiclesOpenImages/416x416/test/annotations_without_background.json',
            metric='bbox',
            type='CocoMetric'),
    ],
...
work_dir = 'experiments/exp_049/eval/t13_odinw'
