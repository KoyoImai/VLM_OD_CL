...
launcher = 'pytorch'
load_from = 'experiments/exp_049/work_dirs/Raccoon/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    seen_tasks=
    'AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushroom,Packages,PascalVOC,pistols,pothole,Raccoon',
    task_id=9,
...
work_dir = 'experiments/exp_049/eval/t10_odinw'
