...
launcher = 'pytorch'
load_from = 'experiments/exp_049/work_dirs/Packages/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    seen_tasks=
    'AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushroom,Packages',
    task_id=5,
...
work_dir = 'experiments/exp_049/eval/t06_odinw'
