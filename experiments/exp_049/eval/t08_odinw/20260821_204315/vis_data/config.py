...
launcher = 'pytorch'
load_from = 'experiments/exp_049/work_dirs/pistols/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    seen_tasks=
    'AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushroom,Packages,PascalVOC,pistols',
    task_id=7,
...
work_dir = 'experiments/exp_049/eval/t08_odinw'
