...
launcher = 'pytorch'
load_from = 'experiments/exp_049/work_dirs/PascalVOC/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    seen_tasks=
    'AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushroom,Packages,PascalVOC',
    task_id=6,
...
work_dir = 'experiments/exp_049/eval/t07_odinw'
