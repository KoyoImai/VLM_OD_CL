...
launcher = 'pytorch'
load_from = 'experiments/exp_049/work_dirs/pothole/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    seen_tasks=
    'AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushroom,Packages,PascalVOC,pistols,pothole',
    task_id=8,
...
work_dir = 'experiments/exp_049/eval/t09_odinw'
