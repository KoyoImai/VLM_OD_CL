...
launcher = 'pytorch'
load_from = 'experiments/exp_049/work_dirs/NorthAmericaMushroom/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    seen_tasks=
    'AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushroom',
    task_id=4,
...
work_dir = 'experiments/exp_049/eval/t05_odinw'
