...
launcher = 'pytorch'
load_from = 'experiments/exp_049/work_dirs/thermalDogsAndPeople/epoch_12.pth'
log_level = 'INFO'
...
model = dict(
    ...
    seen_tasks=
    'AerialMaritimeDrone,Aquarium,CottontailRabbits,EgoHands,NorthAmericaMushroom,Packages,PascalVOC,pistols,pothole,Raccoon,ShellfishOpenImages,thermalDogsAndPeople',
    task_id=11,
...
work_dir = 'experiments/exp_049/eval/t12_odinw'
