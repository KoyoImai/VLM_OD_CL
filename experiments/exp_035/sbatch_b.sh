#!/bin/bash
# =============================================================================
# exp_035_b sbatch.sh — クラスタ実行の「器」。
#   note07 の分割に対応: exp_035_b = 蒸留D（融合後）+ 蒸留E（3項平均）、λ = 10.0
...
#     sbatch experiments/exp_035/sbatch_b.sh          # all（2条件を直列・約64h）
#
...
# =============================================================================
#SBATCH --job-name=exp035b_kdDE_condA_l2w100
...
singularity exec --nv \
  ...
  "$SIF" bash /workspace/kouyou/mmdetection/experiments/exp_035/train_val_b.sh "$RUN_STAGE"
