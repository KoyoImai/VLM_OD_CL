...
model = dict(
    ...
    teacher_ckpt=
    '/workspace/kouyou/mmdetection/experiments/exp_035/kdB_condA_l2w100_electromagnetic_work_dir/epoch_20.pth',
...
work_dir = 'experiments/exp_035/kdB_condA_l2w100_videogames_work_dir'
