...
launcher = 'pytorch'
load_from = './experiments/exp_006/aerial_to_electromagnetic_work_dir/best_coco_bbox_mAP_epoch_20.pth'
log_level = 'INFO'
...
work_dir = './experiments/exp_006/aerial_to_electromagnetic_D2eval'
