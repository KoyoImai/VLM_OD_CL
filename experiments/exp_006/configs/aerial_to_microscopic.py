# =============================================================================
# exp_006 / aerial -> microscopic: 2ドメイン逐次学習（D1=aerial, D2=microscopic）
# -----------------------------------------------------------------------------
# 目的: aerial(D1) を学習済みのモデルから microscopic(D2) を継続学習し、
#       D2 学習後に (a) aerial(D1) の性能低下＝D1忘却、(b) microscopic 適応、(c) COCO累積忘却 を測る。
