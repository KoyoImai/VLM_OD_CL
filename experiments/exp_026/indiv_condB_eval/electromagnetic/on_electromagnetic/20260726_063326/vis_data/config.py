...
launcher = 'pytorch'
load_from = '/workspace/kouyou/mmdetection/experiments/exp_026/indiv_condB_electromagnetic_work_dir/epoch_20.pth'
log_level = 'INFO'
...
work_dir = 'experiments/exp_026/indiv_condB_eval/electromagnetic/on_electromagnetic'
