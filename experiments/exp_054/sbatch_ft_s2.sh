#!/bin/bash
# =============================================================================
# exp_054 ft seed=2 — クラスタ実行の「器」（design.md §3）。
...
echo "SLURM_JOB_ID = ${SLURM_JOB_ID}   CACHE = $CACHE   exp_054 ft seed=2"
...
singularity exec --nv \
  ...
  "$SIF" bash -c "SEED=2 GPUS=4 bash /workspace/kouyou/mmdetection/experiments/exp_054/run_ft.sh"
