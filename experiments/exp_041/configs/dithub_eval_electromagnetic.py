# =============================================================================
# exp_041 DitHub 評価用（6ドメイン逐次ライブラリ対応）/ electromagnetic
#
...
#   項目7で実測確認）。データ・num_classes は exp_023 の eval_electromagnetic.py を継承。既存コード無変更。
# =============================================================================
_base_ = '../../exp_023/configs/eval_electromagnetic.py'
