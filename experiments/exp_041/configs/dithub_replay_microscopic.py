# =============================================================================
# exp_041: DitHub / リプレイ有り / microscopic（逐次 t=5）
#
# 【自動生成】experiments/exp_041/gen_configs.py。直接編集しない。
#
# データ・スケジュール・optimizer は exp_040 と同一にするため、継承元を
# ../../exp_040/configs/replay_microscopic.py に取る（design.md §2.2）。
...
# =============================================================================
_base_ = '../../exp_040/configs/replay_microscopic.py'
...
model = dict(
    ...
    encoder_cp=6,
    dithub_classes=('close', 'open', 'Platelets', 'RBC', 'WBC', 'Ancylostoma Spp',
        'Ascaris Lumbricoides', 'Enterobius Vermicularis',
        'Fasciola Hepatica', 'Hymenolepis', 'Schistosoma', 'Taenia Sp',
        'Trichuris Trichiura', 'celula', '4-fold defect', 'Str_pne',
        'dc', 'Mitosis', 'activated', 'non-activated', 'ballooning',
        'fibrosis', 'inflammation', 'steatosis', 'thick-dark-mark',
        'thick-light-mark', 'thin-dark-mark', 'thin-light-mark'))
