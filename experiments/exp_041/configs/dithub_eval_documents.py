# =============================================================================
# exp_041 DitHub 評価用（6ドメイン逐次ライブラリ対応）/ documents
#
...
#   項目7で実測確認）。データ・num_classes は exp_026 の eval_documents.py を継承。既存コード無変更。
# =============================================================================
_base_ = '../../exp_026/configs/eval_documents.py'
