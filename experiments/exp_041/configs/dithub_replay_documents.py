# =============================================================================
# exp_041: DitHub / リプレイ有り / documents（逐次 t=6）
#
# 【自動生成】experiments/exp_041/gen_configs.py。直接編集しない。
#
# データ・スケジュール・optimizer は exp_040 と同一にするため、継承元を
# ../../exp_040/configs/replay_documents.py に取る（design.md §2.2）。
...
# =============================================================================
_base_ = '../../exp_040/configs/replay_documents.py'
...
model = dict(
    ...
    encoder_cp=6,
    dithub_classes=('caption', 'tweet', 'profile_info', 'table', 'title', 'action',
        'activity', 'commeent', 'control_flow',
        'control_flowcontrol_flow', 'decision_node', 'exit_node',
        'final_flow_node', 'final_node', 'fork', 'merge', 'merge_noode',
        'null', 'object', 'object_flow', 'signal_recept', 'signal_send',
        'start_node', 'text', 'signature', 'author', 'chapter',
        'equation', 'equation number', 'figure', 'figure caption',
        'footnote', 'list of content heading', 'list of content text',
        'page number', 'paragraph', 'reference text', 'section',
        'subsection', 'subsubsection', 'table caption',
        'table of contents text', '-', 'bold_parent_row', 'bold_row',
        'closure_row', 'column', 'direct_children',
        'non_bold_parent_row', 'non_bold_row', 'parent_column',
        'prime_parent', 'sub_row', 'g', 'g1', 'g3', 'h', 'm', 'n'))
