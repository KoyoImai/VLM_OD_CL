# =============================================================================
# exp_011: microscopic 単独FT（Image Backbone(Swin)・Text Backbone(BERT) も 0.1×学習, seed=0）
#   標準 microscopic finetune config を継承し、backbone/language を lr_mult=0.1、seed=0 を設定するのみ。
