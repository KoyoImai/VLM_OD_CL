_data_root = 'data/odinw/Raccoon/Raccoon.v38-416x416-resize.coco/'
...
coco_od_dataset = dict(
    ...
    type='ODVGDataset')
custom_hooks = [
    dict(trained_classes=[], type='DitHubSeqPhaseHook', warmup_iters=1500),
]
custom_imports = dict(
...
launcher = 'none'
load_from = 'experiments/exp_037/dithub_s42_library/lib_after_t03_CottontailRabbits.pth'
log_level = 'INFO'
...
train_cfg = dict(
    max_iters=3000, type='IterBasedTrainLoop', val_interval=100000)
...
work_dir = 'experiments/exp_037/dithub_s42_t04_Raccoon_work_dir'
