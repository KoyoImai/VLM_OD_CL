...
launcher = 'none'
load_from = 'experiments/exp_037/dithub_s42_library/lib_after_t09_EgoHands.pth'
log_level = 'INFO'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'North American Mushrooms.v1-416x416.coco/train/annotations_without_background.json',
        data_prefix=dict(
            img='North American Mushrooms.v1-416x416.coco/train/'),
...
work_dir = 'experiments/exp_037/dithub_s42_t10_NorthAmericaMushrooms_work_dir'
