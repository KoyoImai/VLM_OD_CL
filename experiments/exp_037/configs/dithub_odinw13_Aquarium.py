# =============================================================================
# exp_037: DitHub 学習 config / t=12 Aquarium
#
...
# train split。
#   画像 448 枚 / box 3,324 / クラス 7（3000 iter × batch 2 = 6000 枚で 13.4 周）
#
...
# （公式 do_warmup_a の条件。design.md §1.2）。本タスクは 多クラス（7 クラス、warmup あり） である。
#
