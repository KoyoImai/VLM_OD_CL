# =============================================================================
# exp_037: DitHub 学習 config / t=11 AerialMaritimeDrone
#
...
# train split。
#   画像 371 枚 / box 1,237 / クラス 5（3000 iter × batch 2 = 6000 枚で 16.2 周）
#
...
# （公式 do_warmup_a の条件。design.md §1.2）。本タスクは 多クラス（5 クラス、warmup あり） である。
#
...
_data_root = 'data/odinw/' + 'AerialMaritimeDrone/tiled/'
