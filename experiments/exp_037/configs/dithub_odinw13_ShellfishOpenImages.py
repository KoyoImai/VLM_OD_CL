# =============================================================================
# exp_037: DitHub 学習 config / t=13 ShellfishOpenImages
#
...
# train split。
#   画像 406 枚 / box 858 / クラス 3（3000 iter × batch 2 = 6000 枚で 14.8 周）
#
...
# （公式 do_warmup_a の条件。design.md §1.2）。本タスクは 多クラス（3 クラス、warmup あり） である。
#
...
_data_root = 'data/odinw/' + 'ShellfishOpenImages/416x416/'
