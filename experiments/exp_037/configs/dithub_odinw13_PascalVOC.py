# =============================================================================
# exp_037: DitHub 学習 config / t=02 PascalVOC
#
...
# train split。
#   画像 13,690 枚 / box 31,356 / クラス 20（3000 iter × batch 2 = 6000 枚で 0.4 周）
#
...
# （公式 do_warmup_a の条件。design.md §1.2）。本タスクは 多クラス（20 クラス、warmup あり） である。
#
