...
#   時点: t=13（直前に学習したタスク: ShellfishOpenImages）
#   対象タスク（逐次順）: pistols / PascalVOC / CottontailRabbits / Raccoon / VehiclesOpenImages / Packages / thermalDogsAndPeople / pothole / EgoHands / NorthAmericaMushrooms / AerialMaritimeDrone / Aquarium / ShellfishOpenImages
# =============================================================================
...
datasets = [
    ...
    _base_.dataset_ShellfishOpenImages,
]
metrics = [
    ...
    _base_.val_evaluator_ShellfishOpenImages,
]
