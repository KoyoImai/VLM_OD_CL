# =============================================================================
# exp_037: DitHub 学習 config / t=07 thermalDogsAndPeople
#
...
# train split。
#   画像 142 枚 / box 181 / クラス 2（3000 iter × batch 2 = 6000 枚で 42.3 周）
#
...
# （公式 do_warmup_a の条件。design.md §1.2）。本タスクは 多クラス（2 クラス、warmup あり） である。
#
...
_data_root = 'data/odinw/' + 'thermalDogsAndPeople/'
