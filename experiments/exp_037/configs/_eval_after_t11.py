...
#   時点: t=11（直前に学習したタスク: AerialMaritimeDrone）
#   対象タスク（逐次順）: pistols / PascalVOC / CottontailRabbits / Raccoon / VehiclesOpenImages / Packages / thermalDogsAndPeople / pothole / EgoHands / NorthAmericaMushrooms / AerialMaritimeDrone
# =============================================================================
