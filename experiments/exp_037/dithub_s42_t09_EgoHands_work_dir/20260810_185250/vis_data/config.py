_data_root = 'data/odinw/EgoHands/generic/'
...
launcher = 'none'
load_from = 'experiments/exp_037/dithub_s42_library/lib_after_t08_pothole.pth'
log_level = 'INFO'
...
work_dir = 'experiments/exp_037/dithub_s42_t09_EgoHands_work_dir'
