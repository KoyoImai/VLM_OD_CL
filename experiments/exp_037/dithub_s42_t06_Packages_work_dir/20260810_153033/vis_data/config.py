_data_root = 'data/odinw/Packages/augmented-v1/'
...
launcher = 'none'
load_from = 'experiments/exp_037/dithub_s42_library/lib_after_t05_VehiclesOpenImages.pth'
log_level = 'INFO'
...
work_dir = 'experiments/exp_037/dithub_s42_t06_Packages_work_dir'
