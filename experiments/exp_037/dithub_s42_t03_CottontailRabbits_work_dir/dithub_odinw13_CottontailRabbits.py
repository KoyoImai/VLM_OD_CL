_data_root = 'data/odinw/CottontailRabbits/'
...
launcher = 'none'
load_from = 'experiments/exp_037/dithub_s42_library/lib_after_t02_PascalVOC.pth'
log_level = 'INFO'
...
model = dict(
    ...
    dithub_classes=('Cottontail-Rabbit', ),
    dn_cfg=dict(
        box_noise_scale=1.0,
...
work_dir = 'experiments/exp_037/dithub_s42_t03_CottontailRabbits_work_dir'
